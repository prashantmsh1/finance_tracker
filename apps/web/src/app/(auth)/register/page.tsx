...
export default function RegisterPage() {
    ...
    const { login } = useAuth(); // we'll log them in automatically after register
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const data = await res.json();
            login(data.user); // Automatically log in the user with the returned payload
        } catch (err: any) {
    ...
    return (
        <main className="flex min-h-screen items-center justify-center p-4 relative overflow-hidden bg-gray-50 dark:bg-gray-950">
            ...
            <div className="absolute top-[10%] left-[20%] w-96 h-96 bg-purple-500/30 rounded-full blur-[100px] pointer-events-none mix-blend-multiply dark:mix-blend-screen animate-pulse duration-[10000ms]"></div>
            <div className="absolute bottom-[10%] right-[20%] w-[30rem] h-[30rem] bg-pink-500/30 rounded-full blur-[120px] pointer-events-none mix-blend-multiply dark:mix-blend-screen animate-pulse duration-[15000ms]"></div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500 outline-none transition-all placeholder-gray-400"
